...
<body>
  ...
  <div class="main" id="login">
    <div class="sign" ><img src="/images/newlogo.png" class="new_logo"/></div>
      <form class="form1" id="formLogin" name="formlogin" action="login.php" method="post">
        <div class="inputsGroup"> 
          ...
          <input type="submit" value="Entrar" class="submit" name="submite">
        </div>
        <span class="warning"><a href='index_register.php'>Não é registrado? Registre-se!</a></span>
        <p class="forgot">
          <?php
